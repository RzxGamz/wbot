...
module.exports = {
  ...
  async execute(msg, wa, args) {
    if (args[0]) {
      ...
      ev.sendMessage(msg.from, { documentMessage: doc, contentText: str, footerText: "Shell Bot", buttons: buttons, headerType: "DOCUMENT" }, "buttonsMessage", { quoted: msg, thumbnail: require('fs').readFileSync('././temp/img.png'), contextInfo: { externalAdReply: { title: "Shell Bot", body: "", mediaType: "2", thumbnail: require('fs').readFileSync('././temp/thb.png'), mediaUrl: `https://www.instagram.com` }, mentionedJid: [sender] }})
    }
  },
};
